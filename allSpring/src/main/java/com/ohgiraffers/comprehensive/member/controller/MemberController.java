...
public class MemberController {
    ...
    public MemberController(MessageSourceAccessor messageSourceAccessor, MemberService memberService, AuthenticationService authenticationService, PasswordEncoder passwordEncoder){
    ...
    * 규약에 맞는 HttpResponse를 반환하는데 사용 목적이 있다.*/
    ...
    /* 회원 가입 */
    @PostMapping("/regist")
    public String registMember(@ModelAttribute MemberDTO member, String zipCode,  String address1, String address2,
    ...
    * index 화면으로 이동  */
    ...
    /* 회원 정보 화면 이동 */
    @GetMapping("/delete")
    public String deleteMember(@AuthenticationPrincipal MemberDTO member, RedirectAttributes rttr) throws MemberModifyException, MemberRemoveException {
